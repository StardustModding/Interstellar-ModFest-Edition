...
//    modImplementation("foundry.veil:Veil-forge-${rootProject.property("minecraft_version")}:${rootProject.property("veil_version")}")
    ...
    modRuntimeOnly("lol.bai:badpackets:neo-${rootProject.property("badpackets_version")}")
    modRuntimeOnly("maven.modrinth:yeetus-experimentus:${"yeetus_version"()}")

    modApi("thedarkcolour:kfflang:${"kotlin_for_forge_version"()}")
    modApi("thedarkcolour:kfflib:${"kotlin_for_forge_version"()}")
    modApi("thedarkcolour:kffmod:${"kotlin_for_forge_version"()}")
